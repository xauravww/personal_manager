...
import { AlertCircle, Eye, EyeOff, RefreshCw, Mail, Lock, User, CheckCircle, ArrowRight, Github } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const errorMessage = getErrorMessage(result.error || 'Signup failed');
    ...
    <>
      ...
      <div className="min-h-screen bg-void-950 flex font-sans text-starlight-100 selection:bg-neon-blue selection:text-white">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-void-900 items-center justify-center">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-neon-purple/10 via-transparent to-neon-blue/10" />

          <div className="relative z-10 max-w-lg text-center p-12">
            <div className="mb-12 relative">
              <div className="absolute inset-0 bg-neon-purple/20 blur-[100px] rounded-full animate-pulse-soft" />
              <div className="relative w-64 h-64 mx-auto border border-starlight-100/10 rounded-xl flex items-center justify-center backdrop-blur-sm transform rotate-45">
                <div className="w-48 h-48 border border-starlight-100/20 rounded-xl flex items-center justify-center animate-float">
                  <div className="w-32 h-32 bg-gradient-to-br from-neon-blue to-neon-purple opacity-20 rounded-xl" />
                </div>
              </div>
            </div>
          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center lg:text-left">
              ...
              <p className="text-starlight-400">
                Start your journey with NexusBrain today.
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    {errors.password ? (
                      ...
                      <div className="flex items-center text-xs text-starlight-500 ml-1">
                        <CheckCircle className={`w-3 h-3 mr-1 ${formData.password.length >= 6 ? 'text-neon-green' : 'text-starlight-600'}`} />
                ...
                <div className="space-y-1.5">
                  ...
                  {errors.confirmPassword && (
                    <p className="text-xs text-red-400 ml-1 animate-fade-in">{errors.confirmPassword}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-start">
                <input
                  ...
                  className={`mt-1 h-4 w-4 text-neon-blue focus:ring-neon-blue border-void-700 bg-void-900 rounded cursor-pointer ${errors.termsAccepted ? 'border-red-500' : ''}`}
                />
                <label className="ml-2 block text-sm text-starlight-400">
                  I agree to the{' '}
                  <a href="#" className="font-medium text-neon-blue hover:text-neon-purple transition-colors">
                    Terms of Service
                  </a>{' '}
                  and{' '}
                  <a href="#" className="font-medium text-neon-blue hover:text-neon-purple transition-colors">
              ...
              {errors.termsAccepted && (
                <p className="text-xs text-red-400 ml-1 -mt-4 animate-fade-in">{errors.termsAccepted}</p>
              )}
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-void-950 text-starlight-500">Or sign up with</span>
                </div>
              </div>
            ...
            <p className="text-center text-sm text-starlight-400">
              ...
              <Link to="/login" className="font-medium text-neon-blue hover:text-neon-purple transition-colors">
                Sign in here
              </Link>
            </p>
          </div>
